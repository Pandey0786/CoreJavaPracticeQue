...
public class StringBasic {
	...
	public static void main(String[] args) {
		...
		StringBuffer sb = new StringBuffer("Shashank Pandey");
		 ...
		 * 
		 * System.out.println("All a to z replace by b - " +
		 * name.replaceAll("[a-z]","b") ); System.out.println("Chota vijay - " +
		 * name.toLowerCase()); System.out.println("Bada VIJAY- " + name.toUpperCase());
		 ...
		 * 
		 * System.out.println("Split Name- "); for(String st : name2) {
